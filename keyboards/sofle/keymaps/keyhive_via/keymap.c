...
[_COLEMAK] = LAYOUT_via(
  ...
  KC_LGUI, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_VOLD,       KC_PGDN,  KC_N    , KC_M   , KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                  KC_LCTRL, KC_LALT,MO(_LOWER),KC_LSFT,KC_ENT ,           KC_SPC ,MO(_RAISE),KC_RCTRL, KC_RALT, KC_RGUI
),
*/
...
/*[_COLEMAK] = LAYOUT_via(
  ...
  KC_TAB , MT(MOD_LCTL, KC_A), MT(MOD_LGUI, KC_R), MT(MOD_LALT, KC_S), KC_T   , KC_G   , KC_MUTE,       KC_NO  ,  KC_M    , KC_N   , MT(MOD_RALT,KC_E), MT(MOD_RGUI,KC_I) , MT(MOD_RCTL,KC_O), KC_QUOT,
  KC_LGUI, KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   , KC_VOLD,       KC_PGDN,  KC_K    , KC_H, KC_COMM,KC_DOT, KC_SLSH, MT(MOD_LGUI | MOD_LSFT,KC_EQL),
